; --------------------------------------------------
; TETRISSEMBLY - an attempt at making a tetris game in 8086 assembly.
;
...
;
;   emu8086:
;       Open this file in emu8086, and uncomment the #fasm# line
;       so that emu8086 knows to use the fasm syntax.
;       Now you can compile the file.
